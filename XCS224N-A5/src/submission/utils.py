...
def pad_sents_char(sents, char_pad_token):
    ...
    for sent in sents:
        sent_with_padded_words = []
        for word in sent:
            padded_word = word_pad[:]
            padded_word[:len(word)] = word
            sent_with_padded_words.append(padded_word)
        for i in range(len(sent), max_sen_len):
            sent_with_padded_words.append(word_pad[:])
        sents_padded.append(sent_with_padded_words)
    ### END CODE HERE
